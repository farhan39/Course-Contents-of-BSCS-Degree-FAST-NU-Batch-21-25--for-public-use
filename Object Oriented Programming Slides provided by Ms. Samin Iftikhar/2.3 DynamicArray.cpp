...
void main()
{
	...
	//myArrayPtr = new int[size]; // thats the solution of the solution demanded at line 58 
	// just we need to reallocate memory to pointer or remove deallocation in previous code segment.
