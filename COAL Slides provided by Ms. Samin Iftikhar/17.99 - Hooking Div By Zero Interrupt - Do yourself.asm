...
myisrfor0:	push ax ; push all regs	;offset of this line will be 194
			push bx
			push cx
			push dx
			push si
			...
			mov ax, 0xF1 ; white on blue attribute
...
genint0: 	mov ax, 0x8432		; load a big number in ax
			...
			div bl				; INT 0 will be generated by CPU

			ret

;------------------------------------------------------
start: 	xor ax, ax
		mov es, ax ; load zero in es = 0
